/*
 * coherentpdf.global.d.ts — TypeScript type definitions for hiiirePDF / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the hiiirePDF project.
