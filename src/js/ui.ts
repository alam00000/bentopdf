      ...
      if (!progressContainer) {
        ...
        progressContainer.innerHTML = `
                    <div class="bg-gray-700 rounded-full h-2 overflow-hidden">
                        <div class="loader-progress-bar bg-lime-500 h-full transition-all duration-300" style="width: 0%"></div>
                    </div>
        ...
        ${
          showControls
            ...
            <div id="file-controls" class="hidden mt-4 flex gap-3">
                <button id="add-more-btn" class="btn bg-lime-600 hover:bg-lime-700 text-white font-semibold px-4 py-2 rounded-lg flex items-center gap-2">
