...
function setViewMode(mode: 'overlay' | 'side-by-side') {
  ...
  if (mode === 'overlay') {
    ...
    if (btnOverlay) {
      btnOverlay.classList.add('bg-lime-600');
      btnOverlay.classList.remove('bg-gray-700');
    }
    if (btnSide) {
      btnSide.classList.remove('bg-lime-600');
    ...
    if (btnOverlay) {
      btnOverlay.classList.remove('bg-lime-600');
      btnOverlay.classList.add('bg-gray-700');
    }
    if (btnSide) {
      btnSide.classList.add('bg-lime-600');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (flickerBtn && canvas2) {
    flickerBtn.addEventListener('click', function () {
      ...
      canvas2.style.opacity = flickerVisible
