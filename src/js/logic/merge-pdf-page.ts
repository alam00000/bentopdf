...
async function renderPageMergeThumbnails() {
  ...
  try {
    ...
    const createWrapper = (
      ...
      wrapper.className =
        'page-thumbnail relative cursor-move flex flex-col items-center gap-1 p-2 border-2 border-gray-600 hover:border-slate-950 rounded-lg bg-gray-700 transition-colors';
      ...
      pageNumDiv.className =
        'absolute top-1 left-1 bg-slate-950 text-white text-xs px-2 py-1 rounded-md font-semibold shadow-lg';
...
const resetState = async () => {
  ...
  if (fileModeBtn && pageModeBtn && filePanel && pagePanel) {
    fileModeBtn.classList.add('bg-slate-950', 'text-white');
    fileModeBtn.classList.remove('bg-gray-700', 'text-gray-300');
    pageModeBtn.classList.remove('bg-slate-950', 'text-white');
...
export async function refreshMergeUI() {
  ...
  (state.files as File[]).forEach((f, index) => {
    ...
    input.className =
      'w-full bg-gray-800 border border-gray-600 text-white rounded-md p-2 text-sm mt-1 focus:border-slate-950 focus:ring-1 focus:ring-slate-950 transition-colors';
  ...
  newFileModeBtn.addEventListener('click', () => {
    ...
    newFileModeBtn.classList.add('bg-slate-950', 'text-white');
    newFileModeBtn.classList.remove('bg-gray-700', 'text-gray-300');
    newPageModeBtn.classList.remove('bg-slate-950', 'text-white');
  ...
  newPageModeBtn.addEventListener('click', async () => {
    ...
    newPageModeBtn.classList.add('bg-slate-950', 'text-white');
    newPageModeBtn.classList.remove('bg-gray-700', 'text-gray-300');
    newFileModeBtn.classList.remove('bg-slate-950', 'text-white');
