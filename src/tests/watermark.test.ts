...
describe('Watermark Feature', () => {
  ...
  describe('Watermark Type Toggle', () => {
    ...
    it('should have text radio checked by default', () => {
      const textRadio = document.querySelector('input[name="watermark-type"][value="text"]') as HTMLInputElement;
      const imageRadio = document.querySelector('input[name="watermark-type"][value="image"]') as HTMLInputElement;
  ...
  describe('Watermark Input Validation', () => {
    ...
    it('should accept valid opacity range', () => {
      const opacity = document.getElementById('opacity-text') as HTMLInputElement;
      opacity.value = '0.5';
