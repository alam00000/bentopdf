...
const ALLOWED_ORIGINS = ['https://pdf.hiiire.com', 'https://pdf.hiiire.com'];
  ...
  try {
    ...
    if (!response) {
      response = await fetch(targetUrl, {
        headers: {
          'User-Agent': 'hiiirePDF-WASM-Proxy/1.0',
          Accept: '*/*',
        },
      });
