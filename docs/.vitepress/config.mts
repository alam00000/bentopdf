...
const SITE_URL = 'https://pdf.hiiire.com'

export default defineConfig({
    title: "hiiirePDF Docs",
    description: "Documentation for hiiirePDF - The free, open-source, privacy-first PDF toolkit",
    base: '/docs/',
    cleanUrls: true,
