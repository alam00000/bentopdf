...
export default defineConfig({
  ...
  description:
    'Repository documentation for PaperBridge and the bundled BentoPDF tools surface',
  base: '/docs/',
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Workflow', link: '/contributing' },
      ...
      '/tools/': [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: 'Combine to Single Page',
              link: '/tools/combine-single-page',
            },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Digital Signature', link: '/tools/digital-sign-pdf' },
            {
              ...
              link: '/tools/validate-signature-pdf',
            },
          ],
        },
      ],
    ...
    footer: {
      message:
        'See the repository and dependency licenses before redistribution.',
